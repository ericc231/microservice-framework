...
JAR_NAME="mtls-auth-rest-0.0.1-SNAPSHOT.jar"
EXTENSION_PATH="../../examples/mtls-auth-rest/target/$JAR_NAME"
...
# Start the microservice-app with the mTLS Auth REST in the classpath
./start.sh $1
